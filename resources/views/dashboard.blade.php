<x-app-layout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-white rounded-3xl shadow-xl p-6 border border-gray-100 hover:-translate-y-1 hover:shadow-2xl transition duration-300">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div id="statusIcon"
                        class="w-16 h-16 rounded-2xl bg-emerald-100 flex items-center justify-center text-3xl">
    ...
    <script>
        ...
        async function loadData() {
            ...
            let fanIcon =
                document.getElementById('fanStatusIcon');
            ...
            if (suhu > 30) {
                ...
                fanText.className =
                    'text-3xl font-bold text-green-500 mt-2';

                fanIcon.className =
                    'w-16 h-16 rounded-2xl bg-green-100 flex items-center justify-center text-3xl animate-spin';
                ...
                fanIcon.className =
                    'w-16 h-16 rounded-2xl bg-red-100 flex items-center justify-center text-3xl';
            ...
            if (suhu > 30) {
                ...
                statusEl.className =
                    'text-3xl font-bold text-blue-500 mt-2';

                statusIcon.innerHTML = '❄';

                statusIcon.className =
                    'w-16 h-16 rounded-2xl bg-blue-100 flex items-center justify-center text-3xl';
                ...
                statusEl.className =
                    'text-3xl font-bold text-emerald-500 mt-2';

                statusIcon.innerHTML = '✅';

                statusIcon.className =
                    'w-16 h-16 rounded-2xl bg-emerald-100 flex items-center justify-center text-3xl';
